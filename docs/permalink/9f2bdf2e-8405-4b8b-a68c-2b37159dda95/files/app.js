...
customElements.define('window-container', WindowContainer);
      ...
      document.addEventListener("scroll", (event) => {
        ...
        window.parent.postMessage({ type: 'iframe-scroll', top, left }, '*');
      });

      window.addEventListener( "message", (e) => {

         if (e.data && e.data.type === 'scroll-to') {
           console.log('message: scroll-to', {top: e.data.top, left: e.data.left})
           const packet = { top: e.data.top, left: e.data.left, behavior: "instant" };
           window.scroll(packet);
         }
      ...
      //   // if (e.data && e.data.type === 'scroll-left') window.scroll({ left: e.data.value, behavior: "instant" });
      //   // if (e.data && e.data.type === 'scroll-top') window.scroll({ top: e.data.value, behavior: "instant" });
      //   // if (e.data && e.data.type === 'scroll-left') document.scrollLeft = e.data.value;
      //   // if (e.data && e.data.type === 'scroll-top') document.scrollTop = e.data.value;
      //   // if (e.data && e.data.type === 'scroll-left') document.body.scrollLeft = e.data.value;
      //   // if (e.data && e.data.type === 'scroll-top') document.body.scrollTop = e.data.value;
      //   // if (e.data && e.data.type === 'scroll-left') window.scrollX = e.data.value;
      //   // if (e.data && e.data.type === 'scroll-top') window.scrollY = e.data.value;
      //   // if (e.data && e.data.type === 'scroll-left') window.pageXOffset = e.data.value;
      //   // if (e.data && e.data.type === 'scroll-top') window.pageYOffset = e.data.value;
      // }, false, );
